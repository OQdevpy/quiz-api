...
class AnswerQuestionsView(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        for i in answer_questions:
            i["aswer_questions"]=self.kwargs['id']
            print(i)
            # Answer.objects.create(ball=i['ball'],answer=i['answer'],feedback=i['feedback'],
                                # answer_questions=int(i['answer_questions']),questions=i['questions'])
