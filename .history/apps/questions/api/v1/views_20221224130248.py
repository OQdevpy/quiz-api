...
from .serializers import QuestionsSerializer,QuizSerializer,QuizSerializer
from ...models import Quiz, Questions,Answer, Quiz
    ...
    def perform_create(self, serializer):
        ...
        for i in answer_questions:
            answer=Answer.objects.create(answer=i['answer'],
                                quiz=a,question=Questions.objects.get(id=i['question']))
            answer.save()
        return Response("ok")
