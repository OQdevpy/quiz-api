...
class QuestionListView(viewsets.Ap):
    # serializer_class = QuestionsSerializer
    queryset=Questions.objects.all()
    def get_queryset(self):
        qs=list(Questions.objects.all())
        ...
        return JsonResponse({"questions": qs,"answer_questions":questions},safe=False, status=status.HTTP_200_OK)
